...
type ITask interface {
	...
	GetBy(c context.Context, db *gorm.DB, opts ...DBOptions) (task *model.TaskDo, err error)
	GetListBy(c context.Context, db *gorm.DB, opts ...DBOptions) (tasks []model.TaskDo, err error)
