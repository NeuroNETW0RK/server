...
type ICluster interface {
	...
	GetBy(c context.Context, db *gorm.DB, opts ...DBOptions) (cluster *model.ClusterDo, err error)
	GetListBy(c context.Context, db *gorm.DB, opts ...DBOptions) (clusters []model.ClusterDo, err error)
