...
type IUser interface {
	...
	GetBy(c context.Context, db *gorm.DB, opts ...DBOptions) (user *model.UserDo, err error)
	GetListBy(c context.Context, db *gorm.DB, opts ...DBOptions) (user []model.UserDo, err error)
